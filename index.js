...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.c5cz7.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
    try {
        ...
        const carsdata = database.collection("cardata");
